...
let totalCamisetasCaras = 0;
let totalCamisetasBaratas = 0;
...
for (let i = 0; i < precosCamisetas.length; i++) {
    if (precosCamisetas[i] < 30) {
        ...
        totalCamisetasBaratas += precosCamisetas[i];
    } else {
        totalCamisetasCaras += totalCamisetasBaratas
    }
}

console.table(novoArray);
console.log(`Quantidade de camisetas na arara: ${contadoraCamisetasBaratas}`);
